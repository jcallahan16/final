...
Athlete.delete_all
db = Athlete.create(:first_name => "Dustin", "last_name" => "Pedroia", "image_url" => "http://a.espncdn.com/combiner/i?img=/i/headshots/mlb/players/full/6393.png&w=350&h=254", :team_id => brs.id, :sport_id => base.id, "twitter_name" => "@15LaserShow", "position" => "Infielder")
